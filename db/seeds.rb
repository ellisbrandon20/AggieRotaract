...
attendances = [
    ...
    {:UIN => 987654321, :car_ride => 0, :comments => "more fun fun fun", :wait_listed => 0, :event_id => 1, :time_stamp => '2017-03-26 19:37:13', :approved => 0},
    {:UIN => 123456789, :car_ride => 0, :comments => "fun fun fun", :wait_listed => 0, :event_id => 1, :time_stamp => '2017-03-26 08:00:00', :approved => 0},

    
    {:UIN => 987654321, :car_ride => 0, :comments => "fun fun fun", :wait_listed => 0, :event_id => 2, :time_stamp => '2017-03-26 08:00:00', :approved => 0},
    {:UIN => 123456789, :car_ride => 0, :comments => "more fun fun fun", :wait_listed => 0, :event_id => 2, :time_stamp => '2017-03-26 19:50:13', :approved => 0},
